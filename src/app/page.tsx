...
/* ── Subject catalog ── */
const subjects = [
  { name: "Physics",      level: "igcse", slug: "physics",            code: "4PH1",  icon: "⚡", accent: "accent-orange", color: "#F97316", questions: "650+" },
  { name: "Maths A",      level: "igcse", slug: "maths-a",            code: "4MA1",  icon: "∑",  accent: "accent-blue",   color: "#6EA8FE", questions: "820+" },
  { name: "Maths B",      level: "igcse", slug: "maths-b",            code: "4MB1",  icon: "π",  accent: "accent-blue",   color: "#6EA8FE", questions: "780+" },
  { name: "Chemistry",    level: "igcse", slug: "chemistry",          code: "4CH1",  icon: "⚗",  accent: "accent-green",  color: "#34D399", questions: "590+" },
  { name: "Biology",      level: "igcse", slug: "biology",            code: "4BI1",  icon: "🧬", accent: "accent-green",  color: "#34D399", questions: "540+" },
  { name: "ICT",          level: "igcse", slug: "ict",                code: "4IT1",  icon: "💻", accent: "accent-cyan",   color: "#22D3EE", questions: "310+" },
  { name: "Pure Maths 1", level: "ial",   slug: "pure-mathematics-1", code: "WMA11", icon: "∫",  accent: "accent-violet", color: "#A78BFA", questions: "480+" },
  { name: "Mechanics 1",  level: "ial",   slug: "mechanics-1",        code: "WME01", icon: "⚙",  accent: "accent-amber",  color: "#F59E0B", questions: "260+" },
  { name: "Statistics 1", level: "ial",   slug: "statistics-1",       code: "WST01", icon: "📊", accent: "accent-pink",   color: "#F472B6", questions: "220+" },
]
...
const faqs = [
  ...
  { q: "How do I generate custom worksheets?",                 a: "Use the free Worksheet Generator — select your subject, pick topics, set difficulty and year range, then get a custom PDF with its matching mark scheme in seconds." },
...
const features = [
  { icon: "📄", title: "14+ Years of Past Papers",   desc: "Every Pearson Edexcel question paper from 2010–2025, question papers and mark schemes.",                                    wide: true },
  { icon: "🎯", title: "Topic-Wise Practice",         desc: "Stop wasting time on chapters you've mastered. Drill the exact topics you're weak on." },
  { icon: "⚡", title: "Instant Worksheets",          desc: "Pick subject, topics, difficulty, year range — get a PDF worksheet with mark scheme in seconds.", amber: true, tall: true },
  { icon: "✅", title: "Official Mark Schemes",        desc: "Every question paired with the real Edexcel mark scheme so you know what the examiner wants." },
  { icon: "🔨", title: "Test Builder",                desc: "Hand-pick questions from different years and topics to build your own practice exam." },
  { icon: "📚", title: "9 Subjects",                  desc: "IGCSE Physics, Maths A & B, Chemistry, Biology, ICT — plus IAL Pure Maths, Mechanics & Statistics.", wide: true },
  { icon: "🆓", title: "Always Free",                 desc: "No paywalls. No sign-up required. Every past paper, every mark scheme — free forever." },
  { icon: "📥", title: "PDF Download",                desc: "Download any paper or generated worksheet as a clean, print-ready PDF." },
]
    ...
    <main style={{ background: "#000000", color: "#E5E7EB", minHeight: "100vh" }}>
      ...
      >
        ...
        <div aria-hidden style={{
          ...
          background: "radial-gradient(ellipse, rgba(110,168,254,0.07) 0%, transparent 70%)",
          pointerEvents: "none",
        }} />

        <p style={{ color: "#F59E0B", fontSize: "0.75rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: "1rem" }}>
          Pearson Edexcel Revision Platform
        </p>

        <h1 style={{
          fontSize: "clamp(2.2rem, 5.5vw, 3.75rem)", fontWeight: 800, lineHeight: 1.15,
          letterSpacing: "-0.02em", color: "#E5E7EB", marginBottom: "1.25rem",
        ...
        <p className="hero-description" style={{ color: "#9CA3AF", fontSize: "clamp(1rem,2vw,1.2rem)", lineHeight: 1.7, maxWidth: "540px", margin: "0 auto 0.75rem" }}>
        ...
        <p style={{ color: "#6B7280", fontSize: "0.8rem", marginBottom: "2.5rem" }}>
      ...
      {/* ── STATS STRIP ── */}
      <section style={{ background: "#0B1020", borderTop: "1px solid #1F2937", borderBottom: "1px solid #1F2937", padding: "1.25rem 1.5rem" }}>
        <div style={{ maxWidth: "760px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4,1fr)", textAlign: "center", gap: "1rem" }}>
          {([
      ...
      <section style={{ padding: "5rem 1.5rem", maxWidth: "1080px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          <p style={{ color: "#6EA8FE", fontSize: "0.75rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "0.75rem" }}>Everything You Need</p>
          ...
          <p style={{ color: "#9CA3AF", maxWidth: "440px", margin: "0 auto" }}>Every tool you need to go from struggling to confident — organised, fast, and free.</p>
        </div>
        ...
        <div className="bento-grid">
          {features.map(f => (
            <div
              ...
              style={{
                padding: "1.75rem",
                background: f.amber ? "linear-gradient(135deg,#0B1020 60%,rgba(245,158,11,0.06) 100%)" : "#0B1020",
            ...
            >
              ...
              <h3 style={{ fontSize: "1rem", fontWeight: 700, color: f.amber ? "#F59E0B" : "#E5E7EB", marginTop: "0.25rem" }}>{f.title}</h3>
              <p style={{ fontSize: "0.875rem", color: "#9CA3AF", lineHeight: 1.65, flexGrow: 1 }}>{f.desc}</p>
              {f.amber && (
      ...
      <section style={{ background: "#0B1020", borderTop: "1px solid #1F2937", borderBottom: "1px solid #1F2937", padding: "5rem 1.5rem" }}>
        <div style={{ maxWidth: "1080px", margin: "0 auto" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
            <p style={{ color: "#6EA8FE", fontSize: "0.75rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "0.75rem" }}>Subject Explorer</p>
            <h2 style={{ fontSize: "clamp(1.6rem,4vw,2.4rem)", fontWeight: 800, color: "#E5E7EB", lineHeight: 1.2 }}>Edexcel IGCSE Past Papers</h2>
          ...
          <div style={{ textAlign: "center", marginBottom: "4rem" }}>
            <Link href="/edexcel-igcse-past-papers" style={{ color: "#6EA8FE", fontSize: "0.8rem", textDecoration: "none" }}>View all IGCSE past papers →</Link>
          </div>

          {/* IAL */}
          <div style={{ textAlign: "center", marginBottom: "2rem" }}>
            <h2 style={{ fontSize: "clamp(1.6rem,4vw,2.4rem)", fontWeight: 800, color: "#E5E7EB", lineHeight: 1.2 }}>Edexcel A Level (IAL) Past Papers</h2>
          ...
          <div style={{ textAlign: "center", marginTop: "1.5rem" }}>
            <Link href="/edexcel-a-level-past-papers" style={{ color: "#A78BFA", fontSize: "0.8rem", textDecoration: "none" }}>View all A Level past papers →</Link>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "5rem 1.5rem", maxWidth: "900px", margin: "0 auto" }}>
        <h2 style={{ fontSize: "clamp(1.5rem,3.5vw,2.2rem)", fontWeight: 800, color: "#E5E7EB", textAlign: "center", marginBottom: "3rem" }}>
          Three Steps to Exam Confidence
        </h2>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(220px,1fr))", gap: "1rem" }}>
          {([
            { step: "01", title: "Pick a Subject",       desc: "Choose from 9 Edexcel IGCSE and A Level subjects. Each one organised by topic and year.",                                                         color: "#6EA8FE" },
            { step: "02", title: "Target Weak Topics",   desc: "Browse questions chapter-by-chapter. Focus your revision where it matters most.",                                                                  color: "#F59E0B" },
            { step: "03", title: "Generate & Download",  desc: "Build a custom worksheet from real exam questions. Download it with its mark scheme as a PDF.",                                                    color: "#34D399" },
          ] as const).map(item => (
            <div key={item.step} style={{ background: "#0B1020", border: "1px solid #333333", borderRadius: "0.875rem", padding: "1.75rem" }}>
              <p style={{ fontSize: "2.5rem", fontWeight: 800, color: item.color, opacity: 0.25, lineHeight: 1, marginBottom: "0.875rem" }}>{item.step}</p>
      ...
      {/* ── POPULAR TOPICS ── */}
      <section style={{ background: "#0B1020", borderTop: "1px solid #1F2937", borderBottom: "1px solid #1F2937", padding: "3.5rem 1.5rem" }}>
      ...
      <section style={{ padding: "5rem 1.5rem", maxWidth: "720px", margin: "0 auto" }}>
        ...
        <p style={{ color: "#9CA3AF", fontSize: "0.9rem", lineHeight: 1.75, marginBottom: "1rem" }}>
          ...
          examinations. Research consistently shows that retrieval practice leads to significantly better exam performance and long-term retention.
        </p>
        <p style={{ color: "#9CA3AF", fontSize: "0.9rem", lineHeight: 1.75 }}>
          GradeMax organises every Edexcel past paper question by topic so you can target your weak areas efficiently. All questions come with official mark schemes so you know exactly what the examiner wants.
        </p>
      </section>

      {/* ── WORRY CATCHER ── */}
      <section style={{ background: "#0B1020", borderTop: "1px solid #1F2937", padding: "3.5rem 1.5rem" }}>
        <p style={{ textAlign: "center", fontSize: "0.875rem", fontWeight: 600, color: "#E5E7EB", marginBottom: "0.4rem" }}>Stressed about exams?</p>
        <p style={{ textAlign: "center", color: "#9CA3AF", fontSize: "0.8rem", marginBottom: "1.5rem" }}>Click on your worries to catch them!</p>
        <LazyWorryCatcher />
      </section>
      ...
      <section style={{ padding: "5rem 1.5rem", maxWidth: "680px", margin: "0 auto" }} id="faq">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.625rem" }}>
          {faqs.map((faq, idx) => (
            <details key={idx} style={{ background: "#0B1020", border: "1px solid #333333", borderRadius: "0.75rem", overflow: "hidden" }}>
              ...
              <p style={{ padding: "0 1.25rem 1rem", fontSize: "0.875rem", color: "#9CA3AF", lineHeight: 1.7 }}>{faq.a}</p>
            </details>
          ))}
        </div>
      </section>
      ...
      {/* ── QUICK LINKS ── */}
      <section style={{ background: "#0B1020", borderTop: "1px solid #1F2937", padding: "2.5rem 1.5rem" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto", textAlign: "center" }}>
          <p style={{ fontSize: "0.7rem", fontWeight: 600, color: "#6B7280", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "1rem" }}>Quick Links</p>
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "0.375rem 1rem" }}>
            {([
              ...
              <Link key={href} href={href} className="quick-link" style={{ fontSize: "0.78rem" }}>{label}</Link>
            ))}
          </div>
        </div>
      </section>
