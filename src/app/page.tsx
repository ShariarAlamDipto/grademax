...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white">
      ...
      {/* Stats — social proof near top */}
      <section className="px-4 md:px-8 py-8 bg-gray-50 dark:bg-gray-950">
        <div className="max-w-3xl mx-auto flex justify-around text-center">
          <div>
            <p className="text-2xl font-bold text-emerald-500">1000+</p>
            <p className="text-xs text-gray-500">Questions</p>
          </div>
          <div>
            <p className="text-2xl font-bold text-sky-500">14+</p>
          ...
          <div>
            <p className="text-2xl font-bold text-sky-500">Free</p>
      ...
      <section className="px-4 md:px-8 py-10 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {igcseSubjects.map((s) => (
            <Link
              ...
              className="bg-gray-100 dark:bg-gray-900 rounded-lg px-4 py-3 text-center border border-gray-200 dark:border-gray-800 hover:border-blue-500 dark:hover:border-blue-600 transition-colors"
            >
        ...
        <div className="text-center mt-4">
          <Link href="/edexcel-igcse-past-papers" className="text-blue-500 hover:text-blue-600 dark:hover:text-blue-300 text-xs">
      ...
      <section className="px-4 md:px-8 pb-10 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {ialSubjects.map((s) => (
            <Link
              key={`${s.level}-${s.slug}`}
              href={`/subjects/${s.level}/${s.slug}`}
              className="bg-gray-100 dark:bg-gray-900 rounded-lg px-4 py-3 text-center border border-gray-200 dark:border-gray-800 hover:border-purple-500 dark:hover:border-purple-600 transition-colors"
            >
              <p className="font-medium text-sm">{s.name}</p>
              <p className="text-xs text-gray-500 mt-0.5">{s.code}</p>
            </Link>
        ...
        <div className="text-center mt-4">
          <Link href="/edexcel-a-level-past-papers" className="text-purple-500 hover:text-purple-600 dark:hover:text-purple-300 text-xs">
      ...
      <section className="px-4 md:px-8 py-10 max-w-3xl mx-auto">
        <h2 className="text-lg font-semibold text-center mb-6 text-gray-700 dark:text-gray-300">How to Use Edexcel Past Papers</h2>
        <div className="grid md:grid-cols-3 gap-4">
          <div className="bg-gray-100 dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-800">
            <h3 className="font-medium text-sm text-gray-900 dark:text-white mb-2">1. Pick a Subject</h3>
          ...
          <div className="bg-gray-100 dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-800">
            <h3 className="font-medium text-sm text-gray-900 dark:text-white mb-2">2. Practice by Topic</h3>
            <p className="text-sm text-gray-600 dark:text-gray-500 leading-relaxed">
              Browse questions organized by topic. Focus on weak areas with real Edexcel exam questions and mark schemes.
            </p>
          </div>
          <div className="bg-gray-100 dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-800">
            <h3 className="font-medium text-sm text-gray-900 dark:text-white mb-2">3. Generate Worksheets</h3>
            <p className="text-sm text-gray-600 dark:text-gray-500 leading-relaxed">
      ...
      {/* About Edexcel Past Papers — SEO prose */}
      <section className="px-4 md:px-8 py-8 max-w-3xl mx-auto">
        <h2 className="text-lg font-semibold text-center mb-4 text-gray-700 dark:text-gray-300">Why Practice with Edexcel Past Papers?</h2>
        <p className="text-sm text-gray-600 dark:text-gray-500 leading-relaxed mb-3">
          ...
          <a href="https://qualifications.pearson.com/en/qualifications/edexcel-international-gcses-and-edexcel-certificates.html" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Pearson Edexcel IGCSE</a>{' '}
          and{' '}
          <a href="https://qualifications.pearson.com/en/qualifications/edexcel-international-advanced-levels.html" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">International A Level</a>{' '}
      ...
      {/* Worry Catcher — stress relief, moved to lower page */}
      <section className="py-8 bg-gray-50 dark:bg-gray-950">
        <p className="text-center text-sm mb-2">
          <span className="font-semibold text-gray-700 dark:text-gray-300">Stressed about exams?</span>
        </p>
        <p className="text-center text-gray-500 text-sm mb-4">Click on your worries to catch them!</p>
        <LazyWorryCatcher />
      </section>

      {/* FAQ — compact, SEO value preserved */}
      <section className="px-4 md:px-8 py-8 max-w-2xl mx-auto" id="faq">
        <h2 className="text-lg font-semibold text-center mb-4 text-gray-700 dark:text-gray-300">Frequently Asked Questions</h2>
        <div className="space-y-2">
          {faqs.map((faq, idx) => (
            <details key={idx} className="bg-gray-100 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 group">
              <summary className="px-4 py-3 cursor-pointer text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors list-none flex justify-between items-center">
                {faq.q}
                <svg className="w-4 h-4 text-gray-400 dark:text-gray-600 group-open:rotate-180 transition-transform flex-shrink-0 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
              <p className="px-4 pb-3 text-gray-600 dark:text-gray-500 text-sm leading-relaxed">{faq.a}</p>
            </details>
          ))}
        </div>
      </section>
      ...
      <section className="px-4 md:px-8 py-8 bg-gray-50 dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-sm font-semibold mb-4 text-gray-500 dark:text-gray-400">Quick Links</h2>
          <div className="flex flex-wrap justify-center gap-2">
            <Link href="/edexcel-past-papers" className="text-xs text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors">Edexcel Past Papers</Link>
            <span className="text-gray-400 dark:text-gray-700">·</span>
            <Link href="/edexcel-igcse-past-papers" className="text-xs text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors">IGCSE Past Papers</Link>
            <span className="text-gray-400 dark:text-gray-700">·</span>
            <Link href="/edexcel-a-level-past-papers" className="text-xs text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors">A Level Past Papers</Link>
            <span className="text-gray-400 dark:text-gray-700">·</span>
            <Link href="/edexcel-worksheets" className="text-xs text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors">Worksheet Generator</Link>
            <span className="text-gray-400 dark:text-gray-700">·</span>
            <Link href="/subjects" className="text-xs text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors">All Subjects</Link>
          </div>
        </div>
      </section>
    </main>
