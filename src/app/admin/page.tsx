...
const QUICK_ACTIONS = [
  ...
  { href: "/admin/workbook/verify", label: "Workbook Verification", desc: "Confirm chapter assignments before they reach the book", icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z", color: "#0ea5e9" },
]
