  ...
  return (
    <div className="bg-white dark:bg-gray-800/80 border-gray-200 dark:border-gray-700 rounded-xl flex flex-col h-full overflow-hidden text-gray-900 dark:text-white"> 
      ...
      <div className="shrink-0 p-4 border-t border-gray-700 space-y-2">
        {error && (
          <div className="bg-red-900/80 border-2 border-red-500/70 rounded-lg p-3 mb-2 shadow-lg">
            <div className="flex items-start gap-2">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-red-200 text-xs font-bold uppercase tracking-wide mb-0.5">Generation failed</p>
                <p className="text-red-100 text-sm leading-snug break-words">{error}</p>
              </div>
            </div>
          </div>
        )}
