"""
Phase 5: assemble the Maths B chapterwise workbook into printable PDFs.
...
OUTPUT
------
    data/workbook/mathsb/book/00_Contents.pdf
    data/workbook/mathsb/book/Chapter_01_Number.pdf
    data/workbook/mathsb/book/Chapter_01_Number_MarkScheme.pdf
    ...
...
USAGE
-----
    python scripts/build_mathsb_workbook_pdf.py                     # dry run
...
def main() -> int:
    ...
    print(f"{'=' * 74}\nMATHS B WORKBOOK — CHAPTER PDFs  [{mode}]\n{'=' * 74}")
