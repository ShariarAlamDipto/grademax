"""
Load the classified Maths B workbook into R2 and the database.
...
STABLE SLUGS
------------
Each question gets `MB.CH09.S04.Q021` -- chapter, section, ordinal in chapter.
...
USAGE
-----
    python scripts/load_mathsb_workbook_to_db.py            # dry run
    python scripts/load_mathsb_workbook_to_db.py --execute
    python scripts/load_mathsb_workbook_to_db.py --execute --skip-upload
"""
...
CLASSIFICATIONS_PATH = WORKBOOK_DIR / "mathsb_classifications.json"
ARCHETYPES_PATH = WORKBOOK_DIR / "mathsb_archetypes.json"
...
def main() -> int:
    ...
    if bad:
        ...
        print("  Run remap_mathsb_section_merges.py, or apply the newest section migration.")
        return 1
