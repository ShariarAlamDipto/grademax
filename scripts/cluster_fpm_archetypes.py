"""
Phase 3b: cluster FPM workbook questions into recurring archetypes.
...
USAGE
-----
    python scripts/cluster_fpm_archetypes.py
    python scripts/cluster_fpm_archetypes.py --threshold 0.4
    python scripts/cluster_fpm_archetypes.py --execute
    python scripts/cluster_fpm_archetypes.py --show 9.4
"""
...
OUTPUT_PATH = REPO_ROOT / "data" / "workbook" / "fpm_archetypes.json"
...
def main() -> int:
    ...
    if not CACHE_PATH.is_file():
        print("No classifications yet. Run classify_fpm_workbook_sections.py first.")
        return 1
