#!/usr/bin/env python3
"""
Phase 4 for the IAL Pure Mathematics 4 (WMA14) workbook: upload the segment PDFs to
R2 and load the question rows into Postgres.

    python scripts/load_p4_workbook_to_db.py                  # dry run
    python scripts/load_p4_workbook_to_db.py --execute
    python scripts/load_p4_workbook_to_db.py --execute --skip-upload
...
ARCHETYPES_PATH = REPO_ROOT / "data" / "workbook" / "p4_archetypes.json"

UNIT = "P4"
SUBJECT_CODE = "WMA14"
R2_PREFIX = "workbook/p4"
